(function () {
  ...
  var COLOR_META = {
    Amber:   { dot: "#f3c04a", className: "amber"   },
    Azure:   { dot: "#3aa0d8", className: "azure"   },
    Emerald: { dot: "#44c08a", className: "emerald" },
    Crimson: { dot: "#e25b64", className: "crimson" },
    Violet:  { dot: "#9164d6", className: "violet"  }
  };
  ...
  function card(sh) {
    ...
    var meta  = COLOR_META[color] || COLOR_META.Amber;
  ...
  function normalizeShards(data) {
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      // Object.assign pour éviter l'opérateur spread
  ...
  function boot() {
    ...
    $("#shards-grid").innerHTML = skeleton;
