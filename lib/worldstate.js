// lib/worldstate.js
// Parser v4.6.2 + cache 60s, endpoints officiels — ESM avec require(CJS)

import { createRequire } from "node:module";
const nodeRequire = createRequire(import.meta.url);
const WorldState = nodeRequire("warframe-worldstate-parser"); // v4 CJS → classe
...
function parseV4(text) {
  // v4: classe CJS → il faut instancier
  const ws = new WorldState(text);
  // Normaliser en JSON “pur” (les modèles ont toJSON)
