...
Sorties :
  /mnt/data/enriched_weapons_fixed.json
  /mnt/data/enriched_weapons_change_report.csv
"""
...
SRC = Path("/mnt/data/enriched_weapons(2).json")  # ton JSON d’entrée
OUT_JSON = Path("/mnt/data/enriched_weapons_fixed.json")
OUT_CSV = Path("/mnt/data/enriched_weapons_change_report.csv")
# ------------------------------------
