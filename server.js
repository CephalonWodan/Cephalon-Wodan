...
import { mountMergedStatic } from './routes_merged_static.js';
...
/* -------------------- Routes data fusionnées (JSON locaux) ----------------- */
/* Monte toutes les routes :
   - /warframe (JSON fusionné brut)
   - /warframes, /warframes/:name
   - /archwings, /archwings/:name
   - /necramechs, /necramechs/:name
   - /mods, /mods/:slug
   - /relics, /relics/:era, /relics/:era/:code
*/
mountMergedStatic(app);
